                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <form action={deleteCategoryAction}>
                          <input type="hidden" name="id" value={category.id} />
                          <Button type="submit" size="icon" variant="ghost" className="size-8 rounded-md border border-primary/20 bg-primary/10 text-primary shadow-sm transition hover:bg-primary/20 hover:text-primary" aria-label="Eliminar categoría">
                            <X className="size-4" />
                          </Button>
                        </form>
                      </div>
                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  <form action={deleteSubCategoryAction}>
                                    ...
                                    <Button
                                      ...
                                      size="icon"
                                      variant="ghost"
                                      className="size-8 rounded-md border border-primary/20 bg-primary/10 text-primary shadow-sm transition hover:bg-primary/20 hover:text-primary"
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <form action={deleteBrandAction}>
                          <input type="hidden" name="id" value={brand.id} />
                          <Button type="submit" size="icon" variant="ghost" className="size-8 rounded-md border border-primary/20 bg-primary/10 text-primary shadow-sm transition hover:bg-primary/20 hover:text-primary" aria-label="Eliminar marca">
                            <X className="size-4" />
                          </Button>
                        </form>
                      </div>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <form action={deleteGenderAction}>
                          <input type="hidden" name="id" value={g.id} />
                          <Button type="submit" size="icon" variant="ghost" className="size-8 rounded-md border border-primary/20 bg-primary/10 text-primary shadow-sm transition hover:bg-primary/20 hover:text-primary" aria-label="Eliminar género">
                            <X className="size-4" />
                          </Button>
                        </form>
                      </div>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <form action={deleteAgeGroupAction}>
                          <input type="hidden" name="id" value={a.id} />
                          <Button type="submit" size="icon" variant="ghost" className="size-8 rounded-md border border-primary/20 bg-primary/10 text-primary shadow-sm transition hover:bg-primary/20 hover:text-primary" aria-label="Eliminar grupo de edad">
                            <X className="size-4" />
                          </Button>
                        </form>
                      </div>
