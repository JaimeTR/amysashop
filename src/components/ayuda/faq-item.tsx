    ...
    <div className="overflow-hidden rounded-2xl border border-white/60 bg-white/55 p-4 shadow-sm backdrop-blur-md">
      ...
      >
        <span className="flex items-center gap-3">
          <span className="inline-flex size-9 items-center justify-center rounded-full bg-primary/10 text-primary ring-1 ring-white/50">
        ...
        <ChevronDown
          className={`size-5 transition-transform duration-200 ${open ? "rotate-180 text-primary" : "text-muted-foreground"}`}
        />
      </button>
